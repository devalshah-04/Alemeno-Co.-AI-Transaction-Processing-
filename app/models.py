...
# Stores one row per uploaded file / processing job
class Job(Base):
    __tablename__ = "jobs"
...
# Stores one row per transaction from the CSV, linked to its job
...
# Stores one summary row per job, with the AI-generated report
